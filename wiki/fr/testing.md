...
strict** et couvrant **100 % des lignes** (85 tests).
...
`fileinfo` activées pour la dépendance transitive `oihana/php-controllers`) ;
la documentation API est construite et déployée sur GitHub Pages par
